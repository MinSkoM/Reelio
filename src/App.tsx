  ...
  return (
    <div className="min-h-screen text-foreground">
      <nav className="sticky top-0 z-50 border-b border-white/10 bg-slate-950/75 backdrop-blur-2xl">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          <div className="flex items-center gap-3 text-lg font-semibold tracking-tight text-white sm:text-xl">
            <div className="rounded-2xl bg-gradient-to-br from-orange-400 via-amber-300 to-yellow-200 p-2 text-slate-950 shadow-lg shadow-orange-500/20">
      ...
      <main className="container mx-auto px-4 py-10 sm:py-14">
        <section className="mx-auto mb-8 max-w-5xl rounded-[2rem] border border-white/10 bg-slate-950/60 px-6 py-8 shadow-2xl shadow-slate-950/20 backdrop-blur-xl sm:px-8 sm:py-10">
